...
INSTALLPYTHONDIR := $(DESTDIR)${prefix}/lib/python2.7/site-packages
INSTALLPYEXECDIR := $(DESTDIR)${exec_prefix}/lib/python2.7/site-packages
...
RANLIB		= ranlib
MKDIRHIER	= /Users/amonmoce/Documents/SOA_Class/CORBA/python/omniORBpy-4.2.1/bin/scripts/omkdirhier
INSTLIBFLAGS	= -m 0644
INSTEXEFLAGS	= -m 0755
CP		= cp
MV		= mv -f
CPP		= /usr/local/bin/cpp-4.9
OMKDEPEND	= /usr/local/bin/omkdepend
RMDIRHIER	= $(RM) -rf
